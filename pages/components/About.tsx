      ...
      <div className="mt-16 flex flex-col md:flex-row align-center items-center">
        ...
        <div className="pt-8 md:py-0 md:w-1/2 text-white md:ml-4 text-center md:text-left">
          <div className="about__primary">
            <span>
I'm Kibouch, an aspiring web developer specialized in the MERN stack. I love creating dynamic and interactive web applications using MongoDB, Express.js, React.js, and Node.js
</span>
          </div>
